...
namespace Yadex.Retirement.Services
{
    ...
    public class JsonFileAssetService : IAssetService
    {
        ...
        public MsgResult AddAsset(Asset asset)
        {
            ...
            {
                return new($"Error happened while add asset. \n{e.Message}\n{e.StackTrace}"); 
            }
        }
        ...
        public MsgResult UpdateAsset(Asset updatedAsset)
        {
            ...
            {
                return new($"Error happened to update asset. \n{e.Message}\n{e.StackTrace}"); 
            }
        }
        ...
        public MsgResult DeleteAsset(Guid assetId)
        {
            ...
            {
                return new($"Error happened to delete. \n{e.Message}\n{e.StackTrace}"); 
            }
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Asset[] GetAllAssets() => JsonSerializer.Deserialize<Asset[]>(File.ReadAllText(CurrentFilePath));
